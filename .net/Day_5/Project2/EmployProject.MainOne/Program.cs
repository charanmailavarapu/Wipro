...
namespace EmployProject.MainOne
{
    ...
    {
        public static EmployBal employBal;
        ...
        {
            int empno;
            Console.WriteLine("Enter the employee number of record to be deleted : ");
        ...
        public static void SearchEmployMain()
        {
            ...
            {
                Console.WriteLine("*** Employee records not found ***");
            }
        }
        ...
        public static void AddEmployMain()
        {
            ...
            Console.WriteLine("Enter your Salary : ");
            employ.Basic = Convert.ToDouble(Console.ReadLine());
            //Console.WriteLine("Entered details successfully..");
